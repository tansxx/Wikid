  ...
  return (
    <>
      <div className="flex justify-between items-center mb-[60px] leading-[26px] text-[16px]">
        <h2 className="leading-[32px] text-[24px] lg:leading-[42px] lg:text-[32px] font-semibold">
          베스트 게시글
        </h2>
        ...
        <Link href="/wikiList">
          <button
            type="button"
            className="w-[130px] h-[45px] px-4 py-2 bg-[#4CBFA4] text-white rounded-md lg:w-[160px] leading-[24px] text-[14px] font-semibold"
          >
            게시물 등록하기
          </button>
        </Link>
          ...
          {bestPost.map((post) => (
            ...
            >
              ...
              <div className="p-[20px] pt-[11px] pb-[14px] md:p-[20px] md:pb-[13px] lg:p-[19px] lg:pb-[14px] text-lg">
                <h3 className=" md:mb-[6px] md:text-[18px] font-semibold text-[#474D66]">
                  {post.title}
                </h3>
