...
export default function WikiSearchList({
  ...
  return (
    <>
      <div className="px-[20px] mb-[40px] md:mb-[50px] lg:mb-[57px] text-[#8F95B2] m-full border-box">
        {query.name && (
      ...
      {query.name && profileInfo.length === 0 ? (
        ...
        <div className="relative p-[20px] overflow-x-auto overflow-y-hidden mb-[50px] md:mb-[60px] lg:mb-[100px]">
                ...
                >
                  ...
                  shadow-[0px_4px_20px_0px_#00000014]"
                      >
                        ...
                        <div
                          className=" py-[4px] pl-[10px] pr-[14px] bg-[#EEF9F6] rounded-full
                    w-auto self-start
                      md:self-end
                    whitespace-nowrap truncate"
                        >
                          <IcLink
                            className="inline align-[-6px] mr-2"
                            color="#000"
                          />
                          <button
                            type="button"
                            onClick={() => {
                              navigator.clipboard.writeText(
                                `https://www.wikied.kr/${profile.id}`
                              );
                              alert('링크가 복사되었습니다!');
                            }}
                            className="leading-[18px] md:text-[14px] text-[#4CBFA4]"
                          >
                            https://www.wikied.kr/{profile.id}
                          </button>
                        </div>
