    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="text-4xl font-light mt-8" style={{ color: '#FFFFFF' }}>
            친구의 위키,<br />직접 작성해 봐요
          </div>
        </div>
        ...
        >
          ...
          <div className="text-2xl font-light mt-2" style={{ color: '#FFFFFF' }}>
            친구의 위키,<br />직접 작성해 봐요
          </div>
        </div>
      ...
      >
        <div className="hidden md:block absolute top-32 left-[120px] md:left-[480px] text-left">
          ...
          <div className="text-4xl font-light mt-8" style={{ color: '#474D66' }}>
        ...
        <div className="md:hidden px-4 sm:px-6 text-left mt-10">
          ...
          <div className="text-2xl font-light mt-2" style={{ color: '#474D66' }}>
            친구들이 달아준<br />내용을 확인해 봐요
          </div>
        </div>
      ...
      >
        ...
        <a
          href=""  //로그인 되어있으면 내 위키 페이지 로그인 되어있지 않으면 /login 페이지
